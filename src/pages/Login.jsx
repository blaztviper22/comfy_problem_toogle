...
(store) => 
    ...
    try {
        ...
        //console.log(response); you can check the user here!!
...
const Login = () => {
    ...
    const loginAsGustUser = async () => {
        try {
            ...
            toast.success('welcom guest user');
            navigate('/');
        } catch(error) {
            console.log(error);
    ...
    return (
        <section className="h-screen grid place-items-center">
            <Form method="post" className="card w-96 p-8 bg-base-100 shadow-lg flex flex-col gap-y-4">
                ...
                <button type="button" className="btn btn-secondry btn-block" onClick={loginAsGustUser}>
                    guest user
                </button>
